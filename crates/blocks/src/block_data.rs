...
/// https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/block/data/Directional.html#getFaces()
#[derive(Debug, BlockData)]
...
/// "allowed faces"
/// https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/block/data/MultipleFacing.html
#[derive(Debug, BlockData)]
...
/// Missing the implementation for checking
/// valid Axeses.
/// https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/block/data/Orientable.html#getAxes()
#[derive(Debug, BlockData)]
...
/// Missing an implementation for returning the
/// applicable shapes
/// https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/block/data/Rail.html#getShapes()
#[derive(Debug, BlockData)]
pub struct Rail {
